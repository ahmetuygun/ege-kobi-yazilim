      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto min-w-0 max-w-2xl px-1 text-center sm:px-0">
          <h2
            ...
            className="text-balance text-3xl font-bold tracking-tight text-foreground break-words sm:text-4xl md:text-5xl"
          >
            Dijital Dönüşüm Çözümleri
          </h2>
          <p className="mt-4 text-pretty text-lg leading-relaxed text-muted-foreground break-words [overflow-wrap:anywhere]">
          ...
          {DIJITAL_DONUSUM_TABS.map((tab) => {
            ...
            return (
              <Link
                ...
                className="surface-card group flex min-w-0 max-w-full flex-col overflow-hidden rounded-2xl p-6 transition-transform duration-200 hover:-translate-y-0.5 hover:border-ege-sea/25 sm:p-8"
              >
                ...
                <h3 className="mt-5 min-w-0 text-lg font-semibold leading-snug text-foreground break-words">
                  {tab.label}
                </h3>
                <p className="mt-3 min-w-0 line-clamp-3 text-left text-[15px] leading-relaxed text-muted-foreground break-words [overflow-wrap:anywhere]">
                  {tab.lede}
                </p>
