...
export function DijitalDonusumPageContent() {
  ...
  return (
    <>
      <section className="overflow-x-hidden border-b border-border bg-secondary">
        <div className="mx-auto max-w-5xl min-w-0 px-4 pb-10 pt-[calc(5.5rem+env(safe-area-inset-top))] sm:px-6 sm:pb-16 sm:pt-28 lg:px-8">
          <Button
            ...
            variant="outline"
            size="sm"
            className="mb-6 mt-1 border-border bg-muted/60 sm:mb-8 sm:mt-4 dark:border-white/20 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
          >
            <Link href="/">
          ...
          <h1 className="mt-2 min-w-0 max-w-full text-balance text-2xl font-bold leading-tight tracking-tight text-foreground break-words sm:text-4xl md:text-5xl">
            Dijital Dönüşüm Çözümleri
          </h1>
          <p className="mt-3 max-w-3xl min-w-0 text-pretty text-base leading-relaxed text-muted-foreground sm:mt-4 sm:text-lg break-words [overflow-wrap:anywhere]">
        ...
        <div className="flex w-full min-w-0 max-w-full flex-col gap-8 lg:flex-row lg:gap-12">
          <nav className="w-full min-w-0 max-w-full lg:w-64 lg:max-w-none lg:shrink-0">
            <p
              ...
              className="mb-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground sm:mb-3"
            >
              Konular
            </p>
            <div
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        selected
                          ? "border-ege-sea/50 bg-ege-sea/15 text-foreground shadow-sm shadow-ege-sea/10 dark:text-white"
          ...
          <div
            ...
            className="surface-card box-border min-h-[260px] w-full min-w-0 max-w-full flex-1 overflow-hidden rounded-2xl p-5 sm:min-h-[320px] sm:p-8 md:p-10"
          >
            <div className="min-w-0 max-w-full">
              <h2 className="min-w-0 max-w-full text-xl font-bold tracking-tight text-foreground break-words sm:text-2xl md:text-3xl">
                {active.label}
              </h2>
              <p className="mt-3 min-w-0 max-w-full text-base leading-relaxed text-muted-foreground break-words [overflow-wrap:anywhere] sm:mt-4 sm:text-[17px]">
                {active.lede}
              </p>
              <div className="mt-8 space-y-8 border-t border-border pt-8 sm:mt-10 sm:space-y-10 sm:pt-10">
                {active.sections.map((section) => (
                  ...
                  >
                    ...
                    <div className="mt-2 min-w-0 max-w-full space-y-3 text-[15px] leading-relaxed text-muted-foreground sm:mt-3 sm:space-y-4 sm:text-base">
              ...
              <div className="mt-8 flex min-w-0 max-w-full flex-col gap-3 border-t border-border pt-8 sm:mt-10 sm:flex-row sm:flex-wrap">
                <Button
                  asChild
                  size="xl"
                  variant="outline"
                  className="min-w-0 w-full max-w-full whitespace-normal rounded-xl border-border bg-muted/50 sm:w-auto sm:rounded-full dark:border-white/20 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
                >
